...
/*
      ...
      */
      #define ABL_PROBE_PT_1_X 73
      #define ABL_PROBE_PT_1_Y 91
...
//  #define X_PROBE_OFFSET_FROM_EXTRUDER -62
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {79.98,80.01,405.784,670.00}
#define DEFAULT_AXIS_STEPS_PER_UNIT   {78.4546,80.2199,400.495,640.00}
#define DEFAULT_MAX_FEEDRATE          {100, 100, 6, 26}    // (mm/sec)    
#define DEFAULT_MAX_ACCELERATION      {800,800,80,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
